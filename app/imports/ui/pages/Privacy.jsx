  ...
  <Grid id={PAGE_IDS.PRIVACY} container centered>
    <Grid.Column>
      ...
      <div className="row, about-us-section">
        <Header as="h2" textAlign="left align"> Your privacy is critically important to us. </Header>
        <p>
        ...
        <Header as="h2" textAlign="left align"> Website Visitors </Header>
        <p>
          {/* eslint-disable-next-line max-len */}
        ...
        <Header as="h2" textAlign="left align"> Gathering of Personally-Identifying Information </Header>
        <p>
          {/* eslint-disable-next-line max-len */}
        ...
        <Header as="h2" textAlign="left align"> Security </Header>
        <p>
          {/* eslint-disable-next-line max-len */}
            The security of your Personal Information is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Information, we cannot guarantee its absolute security.
        </p>

        <Header as="h2" textAlign="left align"> Advertisements </Header>
        <p>
          {/* eslint-disable-next-line max-len */}
        ...
        <Header as="h2" textAlign="left align"> Links to External Sites </Header>
        <p>
          {/* eslint-disable-next-line max-len */}
        ...
        <Header as="h2" textAlign="left align"> Protection of Certain Personally - Identifying Information </Header>
        <p>
          {/* eslint-disable-next-line max-len */}
        ...
        <Header as="h2" textAlign="left align"> Aggregated Statistics </Header>
        <p>
          {/* eslint-disable-next-line max-len */}
        ...
        <Header as="h2" textAlign="left align"> Cookies </Header>
        <p>
        ...
        <Header as="h2" textAlign="left align"> Privacy Policy Changes </Header>
        <p>
          {/* eslint-disable-next-line max-len */}
        ...
        <Header as="h2" textAlign="left align"> Credit And Contact Information </Header>
        <p>
