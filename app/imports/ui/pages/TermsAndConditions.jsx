  ...
  <Grid id={PAGE_IDS.TERMS_AND_CONDITIONS} container centered>
    <Grid.Column>
      <div className="about-us-header">
        <Header as="h1" textAlign="center">Welcome to Our Privacy Policy</Header>
      </div>
      <div className="row, about-us-section">
        <Header as="h2" textAlign="left align"> Terms of Use </Header>
        <p>
          Last updated July 01, 2020 <br/>

          AGREEMENT TO TERMS <br/>

          {/* eslint-disable-next-line max-len */}
          These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Volunteer Ally, LLC (“Company“, “we”, “us”, or “our”), concerning your access to and use of the https://volunteerally.org website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY. <br/>
          ...
          THIRD-PARTY WEBSITE AND CONTENT <br/>
          {/* eslint-disable-next-line max-len */}
          ...
          GOVERNING LAW <br/>
          {/* eslint-disable-next-line max-len */}
          These Terms of Use and your use of the Site are governed by and construed in accordance with the laws of the State of Hawaii applicable to agreements made and to be entirely performed within the State of Hawaii, without regard to its conflict of law principles. <br/>
