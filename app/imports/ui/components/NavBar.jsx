        ...
        {currentUser === '' ? ([
          <Dropdown id={COMPONENT_IDS.NAVBAR_LOGIN_DROPDOWN} text="Login/SignUp" pointing="top right" icon={'user'} key='SignIn_SignOut'>
            <Dropdown.Menu>
              ...
              <Dropdown.Item id={COMPONENT_IDS.NAVBAR_ORGANIZATION_SIGNUP} icon="add user" text="Organization Sign up" as={NavLink} exact to="/organization_signup" key="organization_signup"/>
            </Dropdown.Menu>
          </Dropdown>,
        ]) : (
